...
export const AppState = reactive({
  ...
  products: [
    ...
    new Product({
      ...
      additionalAiInfo: '',
      price: '423.99',
      img: getImageUrl('Spectral-Photography-Camera.png'),
    }),
    new Product({
      ...
      additionalAiInfo: '',
      price: '98.99',
      img: getImageUrl('Cursed-Music-Box.png'),
    }),
    new Product({
      ...
      additionalAiInfo: '',
      price: '213.99',
      img: getImageUrl('Shadow-Puppet-Theater.png'),
    }),
    new Product({
      ...
      additionalAiInfo: '',
      price: '89.99',
      img: getImageUrl('Seance-Bell-Set.png'),
    }),
    new Product({
